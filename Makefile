...
objects = EFEDG_main.o hdw.o auxi_dofs.o grad.o Hhat.o initial_condition.o rhs.o rk.o source_values.o\
		  filter.o runtime.o global_def.o random.o
EFEDG: $(objects)
	$(LINKER) $(LDFLAGS) -o EFEDG $(objects) $(LIBS)

gaugeWaveTestObjects = gaugeWaveTest_main.o hdw.o auxi_dofs.o grad.o Hhat.o initial_condition.o rhs.o rk.o source_values.o\
		  global_def.o runtime.o
gaugeWaveTest: $(gaugeWaveTestObjects)
	$(LINKER) $(LDFLAGS) -o gaugeWaveTest $(gaugeWaveTestObjects) $(LIBS)

gaugeWaveTest_main.o: global_def.h initial_condition.h hdw.h rk.h rhs.h
...
initial_condition.o: global_def.h Sch_Harmonic_hp.c Sch_Harmonic_non_hp.c Sch_Kerr_Schild_outgoing.c\
	Sch_Kerr_Schild_ingoing.c Minkovski.c Kerr_Kerr_Schild_ingoing.c gaugeWave.c
