...
{
    *value = (2.*M*z*((4*Power(M,2)*Power(x,2)*z)/
         (Power(Power(x,2) + Power(y,2) + Power(z,2),2.5)*
           (1 + (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(z,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5))) + 
        (4*Power(M,2)*Power(y,2)*z)/
         (Power(Power(x,2) + Power(y,2) + Power(z,2),2.5)*
           (1 + (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(z,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5))) - 
        (2*M*z*(1 + (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5)))/
    ...
    (Power(Power(x,2) + Power(y,2) + Power(z,2),1.5)*
      Power(1. - (2*M)/Power(Power(x,2) + Power(y,2) + Power(z,2),0.5) - 
        (16*Power(M,3)*Power(x,2)*Power(y,2))/
         (Power(Power(x,2) + Power(y,2) + Power(z,2),3.5)*
           (1 + (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(z,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5))) - 
        (16*Power(M,3)*Power(x,2)*Power(z,2))/
         (Power(Power(x,2) + Power(y,2) + Power(z,2),3.5)*
           (1 + (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(z,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5))) - 
        (16*Power(M,3)*Power(y,2)*Power(z,2))/
         (Power(Power(x,2) + Power(y,2) + Power(z,2),3.5)*
           (1 + (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(z,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5))) + 
        (4*Power(M,2)*Power(z,2)*(1 + 
             (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5)))/
         (Power(Power(x,2) + Power(y,2) + Power(z,2),2.)*
           (1 + (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(z,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5))) + 
        (4*Power(M,2)*Power(y,2)*(1 + 
             (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(z,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5)))/
         (Power(Power(x,2) + Power(y,2) + Power(z,2),2.)*
           (1 + (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(z,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5))) + 
        (4*Power(M,2)*Power(x,2)*(1 + 
             (2*M*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(z,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5)))/
         (Power(Power(x,2) + Power(y,2) + Power(z,2),2.)*
           (1 + (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(z,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5))),0.5)) + 
   (2.*M*y*((4*Power(M,2)*Power(x,2)*y)/
         (Power(Power(x,2) + Power(y,2) + Power(z,2),2.5)*
           (1 + (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(z,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5))) + 
        (4*Power(M,2)*y*Power(z,2))/
         (Power(Power(x,2) + Power(y,2) + Power(z,2),2.5)*
           (1 + (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(z,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5))) - 
        (2*M*y*(1 + (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(z,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5)))/
         (Power(Power(x,2) + Power(y,2) + Power(z,2),1.)*
           (1 + (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
        ...
        (4*Power(M,2)*Power(x,2)*(1 + 
         ...
         (Power(Power(x,2) + Power(y,2) + Power(z,2),2.)*
           (1 + (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(z,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5))),0.5)) + 
   (2.*M*x*((4*Power(M,2)*x*Power(y,2))/
         (Power(Power(x,2) + Power(y,2) + Power(z,2),2.5)*
           (1 + (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(z,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5))) + 
        (4*Power(M,2)*x*Power(z,2))/
         (Power(Power(x,2) + Power(y,2) + Power(z,2),2.5)*
           (1 + (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(z,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5))) - 
        (2*M*x*(1 + (2*M*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(z,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5)))/
         (Power(Power(x,2) + Power(y,2) + Power(z,2),1.)*
           (1 + (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
...
{
    *value = (4.*M*x*z*((4*Power(M,2)*Power(x,2)*z)/
         (Power(Power(x,2) + Power(y,2) + Power(z,2),2.5)*
           (1 + (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(z,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5))) + 
        ...
        (4*Power(M,2)*Power(x,2)*(1 + 
         ...
         (Power(Power(x,2) + Power(y,2) + Power(z,2),2.)*
           (1 + (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(z,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5))),0.5)) + 
   (4.*M*x*y*((4*Power(M,2)*Power(x,2)*y)/
         (Power(Power(x,2) + Power(y,2) + Power(z,2),2.5)*
           (1 + (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(z,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5))) + 
        ...
        (4*Power(M,2)*Power(x,2)*(1 + 
         ...
         (Power(Power(x,2) + Power(y,2) + Power(z,2),2.)*
           (1 + (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(z,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5))),0.5)) - 
   (M*((-4.*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),2.) + 
        2/Power(Power(x,2) + Power(y,2) + Power(z,2),1.))*
      ((4*Power(M,2)*x*Power(y,2))/
         (Power(Power(x,2) + Power(y,2) + Power(z,2),2.5)*
           (1 + (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(z,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5))) + 
...
{
    *value = (4.*M*y*z*((4*Power(M,2)*Power(x,2)*z)/
         (Power(Power(x,2) + Power(y,2) + Power(z,2),2.5)*
           (1 + (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(z,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5))) + 
        ...
        (4*Power(M,2)*Power(x,2)*(1 + 
         ...
         (Power(Power(x,2) + Power(y,2) + Power(z,2),2.)*
           (1 + (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(z,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5))),0.5)) - 
   (M*((-4.*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),2.) + 
        2/Power(Power(x,2) + Power(y,2) + Power(z,2),1.))*
      ((4*Power(M,2)*Power(x,2)*y)/
         (Power(Power(x,2) + Power(y,2) + Power(z,2),2.5)*
           (1 + (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(z,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5))) + 
      ...
      (4*Power(M,2)*Power(x,2)*(1 + 
       ...
       (Power(Power(x,2) + Power(y,2) + Power(z,2),2.)*
         (1 + (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
           (2*M*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
           (2*M*Power(z,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5))),0.5) + 
   (4.*M*x*y*((4*Power(M,2)*x*Power(y,2))/
         (Power(Power(x,2) + Power(y,2) + Power(z,2),2.5)*
           (1 + (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(z,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5))) + 
        ...
        (4*Power(M,2)*Power(x,2)*(1 + 
         ...
         (Power(Power(x,2) + Power(y,2) + Power(z,2),2.)*
           (1 + (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(z,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5))),0.5)) + 
   (4.*M*y*z*((4*Power(M,2)*Power(x,2)*y)/
         (Power(Power(x,2) + Power(y,2) + Power(z,2),2.5)*
           (1 + (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(z,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5))) + 
        ...
        (4*Power(M,2)*Power(x,2)*(1 + 
         ...
         (Power(Power(x,2) + Power(y,2) + Power(z,2),2.)*
           (1 + (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(z,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5))),0.5)) + 
   (4.*M*x*z*((4*Power(M,2)*x*Power(y,2))/
         (Power(Power(x,2) + Power(y,2) + Power(z,2),2.5)*
           (1 + (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(z,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5))) + 
...
{
    *value = (6.*M*Power(x,2)*z*((4*Power(M,2)*Power(x,2)*z)/
         (Power(Power(x,2) + Power(y,2) + Power(z,2),2.5)*
           (1 + (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(z,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5))) + 
        ...
        (4*Power(M,2)*Power(x,2)*(1 + 
         ...
         (Power(Power(x,2) + Power(y,2) + Power(z,2),2.)*
           (1 + (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(z,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5))),0.5)) + 
   (6.*M*Power(x,2)*y*((4*Power(M,2)*Power(x,2)*y)/
         (Power(Power(x,2) + Power(y,2) + Power(z,2),2.5)*
           (1 + (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(z,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5))) + 
        ...
        (4*Power(M,2)*Power(x,2)*(1 + 
         ...
         (Power(Power(x,2) + Power(y,2) + Power(z,2),2.)*
           (1 + (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(z,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5))),0.5)) - 
   (M*((-6.*Power(x,3))/Power(Power(x,2) + Power(y,2) + Power(z,2),2.5) + 
...
{
    *value = (6.*M*x*y*z*((4*Power(M,2)*Power(x,2)*z)/
         (Power(Power(x,2) + Power(y,2) + Power(z,2),2.5)*
           (1 + (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(z,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5))) + 
        ...
        (4*Power(M,2)*Power(x,2)*(1 + 
         ...
         (Power(Power(x,2) + Power(y,2) + Power(z,2),2.)*
           (1 + (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(z,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5))),0.5)) - 
   (M*x*((-6.*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),2.5) + 
      ...
      (4*Power(M,2)*Power(x,2)*(1 + 
       ...
       (Power(Power(x,2) + Power(y,2) + Power(z,2),2.)*
         (1 + (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
           (2*M*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
           (2*M*Power(z,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5))),0.5) - 
   (M*y*((-6.*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),2.5) + 
        2/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5))*
      ((4*Power(M,2)*x*Power(y,2))/
         (Power(Power(x,2) + Power(y,2) + Power(z,2),2.5)*
           (1 + (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
        ...
        (4*Power(M,2)*Power(x,2)*(1 + 
         ...
         (Power(Power(x,2) + Power(y,2) + Power(z,2),2.)*
           (1 + (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(z,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5))),0.5)) + 
   (6.*M*x*y*z*((4*Power(M,2)*Power(x,2)*y)/
         (Power(Power(x,2) + Power(y,2) + Power(z,2),2.5)*
           (1 + (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(z,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5))) + 
        ...
        (4*Power(M,2)*Power(x,2)*(1 + 
         ...
         (Power(Power(x,2) + Power(y,2) + Power(z,2),2.)*
           (1 + (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(z,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5))),0.5)) - 
   (M*z*((-6.*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),2.5) + 
        2/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5))*
      ((4*Power(M,2)*x*Power(y,2))/
         (Power(Power(x,2) + Power(y,2) + Power(z,2),2.5)*
           (1 + (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
...
{
    *value = (6.*M*Power(y,2)*z*((4*Power(M,2)*Power(x,2)*z)/
         (Power(Power(x,2) + Power(y,2) + Power(z,2),2.5)*
           (1 + (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(z,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5))) + 
        ...
        (4*Power(M,2)*Power(x,2)*(1 + 
         ...
         (Power(Power(x,2) + Power(y,2) + Power(z,2),2.)*
           (1 + (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(z,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5))),0.5)) - 
   (M*((-6.*Power(y,3))/Power(Power(x,2) + Power(y,2) + Power(z,2),2.5) + 
      ...
      (4*Power(M,2)*Power(x,2)*(1 + 
       ...
       (Power(Power(x,2) + Power(y,2) + Power(z,2),2.)*
         (1 + (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
           (2*M*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
           (2*M*Power(z,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5))),0.5) + 
   (6.*M*x*Power(y,2)*((4*Power(M,2)*x*Power(y,2))/
         (Power(Power(x,2) + Power(y,2) + Power(z,2),2.5)*
           (1 + (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(z,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5))) + 
        ...
        (4*Power(M,2)*Power(x,2)*(1 + 
         ...
         (Power(Power(x,2) + Power(y,2) + Power(z,2),2.)*
           (1 + (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(z,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5))),0.5)) - 
   (M*z*((-6.*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),2.5) + 
        2/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5))*
      ((4*Power(M,2)*Power(x,2)*y)/
         (Power(Power(x,2) + Power(y,2) + Power(z,2),2.5)*
           (1 + (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
      ...
      (4*Power(M,2)*Power(x,2)*(1 + 
       ...
       (Power(Power(x,2) + Power(y,2) + Power(z,2),2.)*
         (1 + (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
           (2*M*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
           (2*M*Power(z,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5))),0.5) + 
   (6.*M*x*y*z*((4*Power(M,2)*x*Power(y,2))/
         (Power(Power(x,2) + Power(y,2) + Power(z,2),2.5)*
           (1 + (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(z,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5))) + 
        ...
        (4*Power(M,2)*Power(x,2)*(1 + 
         ...
         (Power(Power(x,2) + Power(y,2) + Power(z,2),2.)*
           (1 + (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(z,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5))),0.5)) + 
   (6.*M*y*Power(z,2)*((4*Power(M,2)*Power(x,2)*y)/
         (Power(Power(x,2) + Power(y,2) + Power(z,2),2.5)*
           (1 + (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(z,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5))) + 
        ...
        (4*Power(M,2)*Power(x,2)*(1 + 
         ...
         (Power(Power(x,2) + Power(y,2) + Power(z,2),2.)*
           (1 + (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(z,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5))),0.5)) + 
   (6.*M*x*Power(z,2)*((4*Power(M,2)*x*Power(y,2))/
         (Power(Power(x,2) + Power(y,2) + Power(z,2),2.5)*
           (1 + (2*M*Power(x,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(y,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5) + 
             (2*M*Power(z,2))/Power(Power(x,2) + Power(y,2) + Power(z,2),1.5))) + 
